...
Pane {
    ...
    font.pointSize: config.FontSize !== "" ? config.FontSize : Screen.primaryOrientation === Qt.PortraitOrientation ? parseInt(height / 160) : parseInt(height / 80)
    focus: true
